...
function viewStudentStats(id, toogle){
	if(toogle==0){
		//console.log("21213413")
...
function loadStatsPage(){
	...
	for(row_counter = 2; row_counter < table.rows.length; row_counter++){
		...
		// console.log(table.rows[row_counter].cells[3])
		...
		}else if(table.rows[row_counter].cells[2].innerHTML<table.rows[row_counter].cells[3].innerHTML){
	...
	document.getElementById("losses").innerHTML=countLose
...
function switchPlayers(playerNum){
	var avg_yard=Math.round(players[playerNum].pass_yards/players[playerNum].games_played)
	var avg_receive=Math.round(players[playerNum].receiving_yards/players[playerNum].games_played)
	var avg_rec=Math.round((players[playerNum].rushing_yards/players[playerNum].games_played))
	...
	document.getElementById("avg_p_yards").innerHTML=avg_yard
	document.getElementById("avg_r_yards").innerHTML=avg_receive
